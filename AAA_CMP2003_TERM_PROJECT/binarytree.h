...
inorder(binaryTreeNode<elemType> *p) const{ // Recursive function to traverse binary tree with inorder
if (p != NULL)
{
inorder(p->llink);
cout << p->info << " ";
...
template <class elemType>
void binaryTreeType<elemType>::
preorder(binaryTreeNode<elemType> *p) const // Recursive function to traverse binary tree with preorder
{
if (p != NULL)
{
cout << p->info << " ";
